...
\item
  \(H_0:\) \(H_1: \text{ which is to be tested (claim to be tested})\)
\end{enumerate}
...
\begin{center}\includegraphics[width=1\linewidth]{figure/Ch3box5-1} \end{center}
...
\item
  \textbf{p-value: } Probability of observing a \emph{sample statistic} as extreme or more extreme than the one observed \emph{under the assumption that \(H_0\) is true.}
\end{itemize}
...
\begin{center}\includegraphics[width=1\linewidth]{figure/Ch3box6-1} \end{center}
