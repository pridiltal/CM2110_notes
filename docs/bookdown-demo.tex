...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{output}\OperatorTok{$}\NormalTok{expected}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{table2 <-}\StringTok{ }\NormalTok{observed_table }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{as.data.frame}\NormalTok{() }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{rownames_to_column}\NormalTok{() }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{gather}\NormalTok{(Column, Value, }\OperatorTok{-}\NormalTok{rowname)}

\KeywordTok{colnames}\NormalTok{(table2) <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{'Age'}\NormalTok{, }\StringTok{'Mode'}\NormalTok{, }\StringTok{"Count"}\NormalTok{)}
\NormalTok{table2}
\end{Highlighting}
\end{Shaded}
...
\StringTok{    }\KeywordTok{group_by}\NormalTok{(Robot) }\OperatorTok{%>%}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# You can check the level of the robots with the}
\CommentTok{# following code. You should see three character}
\CommentTok{# values because we converted it to factor variable}

\KeywordTok{levels}\NormalTok{(data}\OperatorTok{$}\NormalTok{Robot)}
\end{Highlighting}
\end{Shaded}
...
\StringTok{    }\KeywordTok{group_by}\NormalTok{(Robot) }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{summarise}\NormalTok{(}
        \DataTypeTok{count_robots =} \KeywordTok{n}\NormalTok{(),}
        \DataTypeTok{mean_time =} \KeywordTok{mean}\NormalTok{(Reponse_time, }\DataTypeTok{na.rm =} \OtherTok{TRUE}\NormalTok{),}
        \DataTypeTok{sd_time =} \KeywordTok{sd}\NormalTok{(Reponse_time, }\DataTypeTok{na.rm =} \OtherTok{TRUE}\NormalTok{)}
\NormalTok{    )}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{p <-}\StringTok{ }\KeywordTok{ggplot}\NormalTok{(data, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ Robot , }\DataTypeTok{y =}\NormalTok{ Reponse_time, }\DataTypeTok{fill =}\NormalTok{ Robot)) }\OperatorTok{+}
\StringTok{    }\KeywordTok{geom_boxplot}\NormalTok{() }\OperatorTok{+}
\StringTok{    }\KeywordTok{geom_point}\NormalTok{()}

\NormalTok{overall_mean <-}\StringTok{  }\KeywordTok{mean}\NormalTok{(data}\OperatorTok{$}\NormalTok{Reponse_time)}

\NormalTok{p }\OperatorTok{+}\StringTok{ }\KeywordTok{geom_hline}\NormalTok{(}\DataTypeTok{yintercept =}\NormalTok{ overall_mean)}
\end{Highlighting}
\end{Shaded}
